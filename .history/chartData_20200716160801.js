chartData={
    ...
    chart2 : {
        ...
        colors : ['#ffffff', '#d3f4ec', '#92e5d1', '#50d5b5', '#1da282'],
        type: 'bar'
    },
    chart3 : {
        id: 3,
        ...
        colors: ["#ffffff", "#26C79E","#126551","#bdefe3","#bdefe3"],
        data: [2478,5267,9000,784,433],
        type: 'horizontalBar',
    },
    chart4 : {
        id: 4,
        ...
        colors : ["#ffffff", "#ffffff","#3cba9f","#e8c3b9","#c45850", "#ffffff"],
        type: 'line'
    },
