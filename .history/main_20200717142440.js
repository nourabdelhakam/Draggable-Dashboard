...
(function() {
	...
	if(temp!= null){
		...
		for( chart in templateList){
			...
			console.log('x: '+templateList[chart].gridMap.gsX);
			console.log('y: '+templateList[chart].gridMap.gsY);
			console.log('w: '+templateList[chart].gridMap.gsWidth);
			console.log('h: '+templateList[chart].gridMap.gsHeight);
...
function dragEnterListener(el) {
    el.addEventListener("dragenter", function (e) {
      e.preventDefault();
	  this.style.backgroundColor = "#1B2A47";
    });
}
